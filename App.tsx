...
function App() {
  ...
  return (
    <div className="relative w-screen h-screen bg-black overflow-hidden select-none">
      ...
      {/* Layer 2: UI Overlay */}
      <div className="absolute inset-0 z-10 flex items-center justify-center p-2 md:p-4">
        {/* Glassmorphism Container */}
        <div className="relative w-full max-w-5xl h-[85vh] md:h-[80vh] bg-theme-overlay backdrop-blur-md rounded-lg border border-theme shadow-[0_0_60px_rgba(255,255,255,0.05)] flex flex-col overflow-hidden transition-all duration-500 ease-in-out">
